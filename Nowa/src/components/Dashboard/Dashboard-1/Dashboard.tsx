                  ...
                  <div className="browser-stats">
                    <div className="d-flex align-items-center item  border-bottom my-2">
                      <div className="d-flex">
                        <img
                          src={
                            require("../../../assets/img/svgicons/chrome.svg")
                              .default
                          }
                          alt="img"
                    ...
                    <div className="d-flex align-items-center item  border-bottom my-2">
                      <div className="d-flex">
                        <img
                          src={
                            require("../../../assets/img/svgicons/edge.svg")
                              .default
                          }
                          alt="img"
                          className="ht-30 wd-30 me-2"
                    ...
                    <div className="d-flex align-items-center item  border-bottom my-2">
                      <div className="d-flex">
                        <img
                          src={
                            require("../../../assets/img/svgicons/firefox.svg")
                              .default
                          }
                          alt="img"
                          className="ht-30 wd-30 me-2"
                    ...
                    <div className="d-flex align-items-center item  border-bottom my-2">
                      <div className="d-flex">
                        <img
                          src={
                            require("../../../assets/img/svgicons/safari.svg")
                              .default
                          }
                          alt="img"
                          className="ht-30 wd-30 me-2"
                    ...
                    <div className="d-flex align-items-center item my-2">
                      <div className="d-flex">
                        <img
                          src={
                            require("../../../assets/img/svgicons/opera.svg")
                              .default
                          }
                          alt="img"
                          className="ht-30 wd-30 me-2"
